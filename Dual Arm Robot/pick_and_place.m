function [end_test_0,place_pos,above_place_pos,above_pickup_pos]=pick_and_place(origine_table,length_nbre,width_nbre,height_nbre,cube_dimensions,width_offset,length_offset,place_pos,above_place_pos,above_pickup_pos)
end_test_0=0;
persistent w l h % declare static variable
if isempty (w)
    w=1;
end
if isempty (l)
